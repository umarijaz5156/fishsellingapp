...
<x-modals.modal maxWidth="2xl" wire:model.live="changePaymentStatusModal">
    @slot('headerTitle')
        Are you sure?
    @endslot
    ...
    @slot('content')
        <div class="p-6 text-center">
            ...
            <button wire:click.prevent="updatePaymentStatus()" type="button"
            ...
            <button wire:click="$toggle('changePaymentStatusModal')" wire:loading.attr="disabled" type="button"
