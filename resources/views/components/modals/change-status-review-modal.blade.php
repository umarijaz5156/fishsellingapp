...
<x-modals.modal maxWidth="2xl" wire:model.live="changeStatusReviewModal">
    @slot('headerTitle')
        Are you sure?
    @endslot
    ...
    @slot('content')
        <div class="p-6 text-center">
            ...
            <button wire:click.prevent="updateReviewStatus()" type="button"
            ...
            <button wire:click="$toggle('changeStatusReviewModal')" wire:loading.attr="disabled" type="button"
