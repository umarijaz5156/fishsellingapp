<div>
    ...
    <section>
        <div class="max-w-screen-xl mx-auto px-4 mt-16 md:mt-12 mb-10">
            <p class=" text-3xl mb-2 md:mb-6 font-bold text-blue">{{ ___('Fish') }}</p>
            <p class="text-body-text">{{ ___("Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in
