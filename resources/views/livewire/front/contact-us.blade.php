<div>
    ...
    <section class="py-5 mb-9">
        <div class="container xl:max-w-screen-2xl mx-auto px-4">
            ...
            <body class="bg-gray-800 text-gray-100  py-12">
                <div
                    class="max-w-screen-xxl grid gap-8 grid-cols-1 md:grid-cols-2 md:px-12 mx-auto bg-gray-100 text-gray-900 rounded-lg shadow-lg">
                    <div class="flex p-8 flex-col justify-between">
                        <div>
                            <h2 class="text-4xl lg:text-5xl font-bold leading-tight">{{ ___('Get in Touch') }}</h2>
                            <div class="text-gray-700 mt-8">
                                Hate forms? Send us an <a href="mailto:{{ $adminEmail }}" class="underline">{{ ___('email') }}</a> {{ ___('instead') }}.
                            </div>
                        </div>
                        ...
                        <div class="mt-8 text-center">
                            <svg class="w-full" xmlns="http://www.w3.org/2000/svg"
                                ...
                                <defs>
                                    <linearGradient id="eb6c86d6-45fa-49e0-9a60-1b0612516196" x1="819.07"
                                        y1="732.58" x2="819.07" y2="560.46" gradientUnits="userSpaceOnUse">
                                    ...
                                    <linearGradient id="a964f849-fa65-4178-8cc4-fb8fb10b3617" x1="462.91"
                                        y1="660.68" x2="462.91" y2="559.69"
                                ...
                                <g opacity="0.1">
                                    ...
                                    <path
                                        ...
                                        transform="translate(-52 -162.63)" fill="#F1691E" />
                                    <path
                                ...
                                <ellipse cx="548" cy="493.13" rx="548" ry="8.86" fill="#F1691E"
                                    opacity="0.1" />
                                <ellipse cx="548" cy="565.88" rx="548" ry="8.86" fill="#F1691E"
                                    opacity="0.1" />
                                <ellipse cx="548" cy="341.3" rx="548" ry="8.86" fill="#F1691E"
                                    opacity="0.1" />
                                <ellipse cx="548" cy="417.21" rx="548" ry="8.86" fill="#F1691E"
                                    opacity="0.1" />
                                <path
                                    ...
                                    transform="translate(-52 -162.63)" fill="#F1691E" opacity="0.1" />
                                <path
                    ...
                    <form class="p-8" wire:submit.prevent="StoreContact">
                        <div>
                            <span class="uppercase text-sm text-gray-600 font-bold">{{ ___('Full Name') }}</span>
                        ...
                        <div class="mt-2">
                            <span class="uppercase text-sm text-gray-600 font-bold">{{ ___('Email') }}</span>
                        ...
                        <div class="mt-2">
                            <span class="uppercase text-sm text-gray-600 font-bold">{{ ___('Phone Number') }}</span>
                            <input wire:model="number"
                                   class="w-full bg-gray-300 text-gray-900 mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline"
                                   type="text"
                                   placeholder="{{ ___('Enter phone number with country code (+)') }}">
                            <x-input-error for="number" />
                        </div>
                        
                        
                        <div class="mt-2">
                            <span class="uppercase text-sm text-gray-600 font-bold">{{ ___('Message') }}</span>
                            <textarea wire:model.live="message" class="w-full h-32 text-gray-900 mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline"></textarea>
                        </div>
                        <x-input-error for="message" />

                        <div style="display: flex; align-items: center; justify-content: center;">
                            <div style="flex: 1;">
                                <span>{{ ___('Captcha') }}:</span>
                                @if ($captcha)
                                    <img style="width: 50%; display: block; margin: 0 auto;" src="{{ $captcha }}" alt="Captcha Image">
                                @else
                                    <span>{{ ___('No captcha generated') }}.</span>
                                @endif
                            </div>
                            <div>
                                <button style="margin-left: 10px;" wire:click="generateCaptcha" type="button">{{ ___('Refresh') }}</button>
                            </div>
                        </div>
                        
                        <div class="mt-2">
                            <span class="uppercase text-sm text-gray-600 font-bold">{{ ___('Captcha') }}</span>
                            <input wire:model.live="captchaInput"
                            class="w-full bg-gray-300 text-gray-900 mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline"
                            type="text" placeholder="{{ ___('Enter Captcha') }}">
                        </div>
                        <x-input-error for="captchaInput" />


                        <div class="mt-8">
                            <button
                                class="uppercase text-sm font-bold tracking-wide  bg-[#F1691E] text-white p-3 rounded-lg w-full focus:outline-none focus:shadow-outline">
                                {{ ___('Send Message') }}
                            </button>
                        </div>
                    </form>
