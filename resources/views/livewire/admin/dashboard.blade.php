<div>
    ...
    <div class="w-full px-6 py-6 mx-auto">
        ...
        <div class="flex flex-wrap -mx-3">
                ...
                <div
                    ...
                    <div class="flex-auto p-4">
                        <div class="flex flex-row -mx-3">
                            <div class="flex-none w-2/3 max-w-full px-3">
                                <div>
                                    <p class="mb-0 font-sans font-semibold leading-normal text-sm">Total Products</p>
                                    <h5 class="mb-0 font-bold">
                                        {{ $productCount }}
                                    </h5>
                                </div>
                ...
                <div
                    ...
                    <div class="flex-auto p-4">
                        <div class="flex flex-row -mx-3">
                            <div class="flex-none w-2/3 max-w-full px-3">
                                <div>
                                    <p class="mb-0 font-sans font-semibold leading-normal text-sm">Total Sellers</p>
                                    <h5 class="mb-0 font-bold">
                                        {{ $sellerCount }}
                                    </h5>
                                </div>
            ...
            <div class="w-full mt-4 max-w-full px-3 sm:w-1/2 sm:flex-none xl:w-1/4">
                <div
                    class="relative flex flex-col min-w-0 break-words bg-white shadow-soft-xl rounded-2xl bg-clip-border">
                    <div class="flex-auto p-4">
                        <div class="flex flex-row -mx-3">
                            <div class="flex-none w-2/3 max-w-full px-3">
                                <div>
                                    <p class="mb-0 font-sans font-semibold leading-normal text-sm">Total Order Price</p>
                                    <h5 class="mb-0 font-bold">
                                        {{  $earning }}
                                    </h5>
                                </div>
                ...
                <div
                    ...
                    <div class="flex-auto p-4">
                        <div class="flex flex-row -mx-3">
                            <div class="flex-none w-2/3 max-w-full px-3">
                                <div>
                                    <p class="mb-0 font-sans font-semibold leading-normal text-sm">My Earning</p>
                                    <h5 class="mb-0 font-bold">
                                        {{  $adminEarning }}
                                    </h5>
                                </div>
                ...
                <div
                    ...
                    <div class="flex-auto p-4">
                        <div class="flex flex-row -mx-3">
                            <div class="flex-none w-2/3 max-w-full px-3">
                                <div>
                                    <p class="mb-0 font-sans font-semibold leading-normal text-sm">Total Payout</p>
                                    <h5 class="mb-0 font-bold">
                                        {{  $total_payout }}
                                    </h5>
                                </div>
                ...
                <div
                    ...
                    <div class="flex-auto p-4">
                        <div class="flex flex-row -mx-3">
                            <div class="flex-none w-2/3 max-w-full px-3">
                                <div>
                                    <p class="mb-0 font-sans font-semibold leading-normal text-sm">Pending Payout</p>
                                    <h5 class="mb-0 font-bold">
                                        {{  $pending_payout }}
                                    </h5>
                                </div>
        ...
        <div class="flex flex-wrap mt-6 -mx-3">
                        ...
                        <div class="flex flex-wrap -mx-3">
                            <div class="max-w-full px-3 lg:w-1/2 lg:flex-none">
                                <div class="flex flex-col h-full">
                                    <p class="pt-2 mb-1 font-semibold">Fresh Catch</p>
                                    <h5 class="font-bold">Fish App Dashboard</h5>
                                    <p class="mb-12">Explore the wide variety of fish available in our app, from salmon to tuna and everything in between.</p>
            ...
            <div class="w-full max-w-full px-3 lg:w-5/12 lg:flex-none">
                <div class="border-black/12.5 shadow-soft-xl relative flex h-full min-w-0 flex-col break-words rounded-2xl border-0 border-solid bg-white bg-clip-border p-4">
                    <div class="relative h-full overflow-hidden bg-cover rounded-xl" style="background-image: url('{{ asset('images/img/slide1.webp') }}')">
                        <span class="absolute top-0 left-0 w-full h-full bg-center bg-cover bg-gradient-to-tl from-gray-900 to-slate-800 opacity-80"></span>
                        <div class="relative z-10 flex flex-col flex-auto h-full p-4">
                            <h5 class="pt-2 mb-6 font-bold text-white">Fishermen's Tales</h5>
                            <p class="text-white">Dive into the captivating stories of fishermen as they navigate the open seas in search of the perfect catch.</p>
